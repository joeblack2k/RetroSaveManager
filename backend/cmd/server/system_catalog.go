...
func manufacturerForSystem(slug, name string) string {
	...
	switch {
	case strings.Contains(lookup, "nintendo"), strings.Contains(lookup, "gameboy"), strings.Contains(lookup, "game boy"), strings.Contains(lookup, "snes"), strings.Contains(lookup, "n64"):
		return "Nintendo"
