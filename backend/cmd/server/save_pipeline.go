...
func (a *app) decorateLoadedRecord(record *saveRecord) {
	...
	normalized := a.normalizeSaveInputDetailedWithOptions(saveCreateInput{
		...
		PortID:                record.Summary.PortID,
		PortName:              record.Summary.PortName,
		OriginSystemSlug:      record.Summary.OriginSystemSlug,
		PortSaveKind:          record.Summary.PortSaveKind,
		RelativePath:          record.Summary.RelativePath,
		RootRelativePath:      record.Summary.RootRelativePath,
		SlotID:                record.Summary.SlotID,
