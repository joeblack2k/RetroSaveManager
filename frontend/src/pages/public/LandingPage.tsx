...
export function LandingPage(): JSX.Element {
  return (
    <div className="grid two-cols">
      ...
      <SectionCard title="In scope" subtitle="Self-hosted web UI + helper compatibility, zonder hosted account surface.">
        <ul className="plain-list">
          <li>Save library, save detail, upload preview, conflicts, devices, settings</li>
          <li>Helper pairing and app-password flows for trusted LAN deployments</li>
          <li>Validation, module support, cheat editors, privacy, about</li>
